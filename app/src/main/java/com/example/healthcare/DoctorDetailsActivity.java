...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    private String[][] doctor_details4 = {
            ...
            {"Doctor Name: Dr. Deepak Kumar Benia", "Hospital Address: IMS & SUM Hospital, K-8, Kalinga Nagar, Ghatikia, Bhubaneswar", "Experience: 5 years","Mobile number = +91 9201345678","1000"},
            {"Doctor Name: Dr. Kishan Kishan", "Hospital Address: IMS & SUM Hospital, K-8, Kalinga Nagar, Ghatikia, Bhubaneswar", "Experience: 14 years","Mobile number = +91 8754903126","1100"},
            {"Doctor Name: Dr. Pradeep Kumar Jena", "Hospital Address: KIMS Hospital, Baramunda, Bhubaneswar", "Experience: 22 year","Mobile number = +91 7012349856","1200"},
            ...
            {"Doctor Name: Dr. Rajeev Kumar", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar", "Experience: 20 years","Mobile number = +91 8347216590","1500"},
            {"Doctor Name: Dr. Nidhi Rathi", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar", "Experience: 15 years","Mobile number = +91 7563021984","1000"},
            {"Doctor Name: Dr. Suman K. Behera", "Hospital Address: Kalinga Institute of Medical Sciences (KIMS), Patia, Bhubaneswar", "Experience: 25 years","Mobile number = +91 9154786203","1100"},
    ...
    private String[][] doctor_details5 = {
            {"Doctor Name: Dr. Prasant Kumar Sahoo", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar","Experience: 37 years","Mobile number = +91 7896541230", "1000"},
            {"Doctor Name: Dr. P C Rath", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar","Experience: 36 years","Mobile number = +91 9087612345", "1000"},
            {"Doctor Name: Dr. Byomakesh Dikshit", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar","Experience: 8 years","Mobile number = +91 8765439081", "1000"},
            {"Doctor Name: Dr. Brajaraj Das", "Hospital Address: Apollo Hospitals, Gajapati Nagar, Bhubaneswar","Experience: 25 years","Mobile number = +91 7654321876", "1000"},
            ...
            {"Doctor Name: Dr. Sushil Kumar", "Hospital Address: KIMS Hospital, Baramunda, Bhubaneswar","Experience: 15 years","Mobile number = +91 8523679014", "1000"},
            {"Doctor Name: Dr. Satyaprakash Mishra", "Hospital Address: KIMS Hospital, Baramunda, Bhubaneswar","Experience: 18 years","Mobile number = +91 9632587410", "1000"},
            {"Doctor Name: Dr. Rajeev Kumar", "Hospital Address: SUM Hospital, K-8, Kalinga Nagar, Ghatikia, Bhubaneswar","Experience: 20 years","Mobile number = +91 7418529630", "1100"}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent it = getIntent();
        String title = it.getStringExtra("tittle");
        tv.setText(title);
        ...
        btn.setOnClickListener(view -> startActivity(new Intent(DoctorDetailsActivity.this, FindDoctor_Activity.class)));
        ...
        lst.setOnItemClickListener((adapterView, view, i, l) -> {
            Intent intent = new Intent(DoctorDetailsActivity.this, Book_Appointment_Activity.class);
            intent.putExtra("text1", doctor_details[i][0].substring(14)); // Extract name after "Doctor Name : "
